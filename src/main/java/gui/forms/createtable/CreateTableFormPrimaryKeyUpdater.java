...
/**
 * Custom updater for {@link CreateTableForm} that updates Primary key Name
 * to value "id_tablename" and primary key constraint to "P_TABLENAME".
 */
public class CreateTableFormPrimaryKeyUpdater implements LBJFormUpdater<CreateTableForm> {
